...
* **Incentive Architecture:** Petitions are sent simultaneously to the City Council, ward councillors, and the Ministry (which holds recall authority over councillors)[cite: 1].
* **Core Question:** Does upper-level monitoring create the bureaucratic risk aversion necessary to turn formal complaints into actual problem resolution[cite: 1]?
